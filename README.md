...
See [charter](docs/charter.md), [rubric](docs/evaluation-rubric.md), [properties to preserve](docs/current-rig-value.md), and the program outcome: [final recommendation](docs/final-recommendation.md), [migration plan](docs/migration-plan.md), [maintenance estimate](docs/maintenance-estimate.md), [security incidents](docs/security-incidents.md). Research runs strictly A → F → C → B → E → D, with separate reviewed PRs.
